return {
    ...
    keys = {
        ...
        },
        {
            "glU",
            function()
                require("gitlab").choose_merge_request { reviewer_username = "aravk_altair", open_reviewer = true }
            end,
            mode = "n",
        ...
        {
            "gla",
            function() require("gitlab").choose_merge_request { reviewer_username = "aravk_altair", state = "all", open_reviewer = true } end,
            mode = "n",
            desc = "Choose aravk_altair MRs",
        },
    },
